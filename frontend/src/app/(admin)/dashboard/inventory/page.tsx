...
export default function InventoryPage() {
  return (
    <section className="rounded-2xl border border-white/10 bg-zinc-900/70 p-12 shadow-2xl shadow-slate-950/30 text-center flex flex-col items-center justify-center min-h-[460px]">
      ...
      <h2 className="text-xl font-bold text-white mb-2">Active Inventory Console</h2>
      <p className="max-w-md text-sm text-zinc-400">
        This sub-module reports real-time metrics for customized expeditions, active bookings, log files, and client-side terminal memory caches.
      </p>
